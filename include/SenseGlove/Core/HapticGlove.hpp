...
public:
    ...
    void SetHandGeometry(const Kinematics::BasicHandModel& handGeometry) const;
    Kinematics::BasicHandModel& GetHandGeometry() const;
...
public:
    ...
    /// <returns></returns>
    static std::vector<std::shared_ptr<HapticGlove>> GetHapticGloves(bool connectedOnly = true);
...
public:
    ...
    /// <returns></returns>
    virtual bool GetHandAngles(std::vector<std::vector<Kinematics::Vect3D>>& out_handAngles);
...
public:
    ...
    /// <returns></returns>
    virtual bool QueueFFBLevel(int32_t finger, float level01);
    ...
    /// <returns></returns>
    virtual bool QueueFFBLevels(std::vector<float> levels01);
    ...
    /// <returns></returns>
    virtual bool SupportsCustomWaveform(EHapticLocation atLocation);
    ...
    /// <returns></returns>
    virtual bool SendCustomWaveform(CustomWaveform& waveform, EHapticLocation location);
...
public:
    ...
    virtual EHapticGloveCalibrationState GetCalibrationState();
    ...
    virtual std::string GetCalibrationInstruction();

    static std::string ToString(EHapticGloveCalibrationState state);
