...
public:
    ...
    /// <returns></returns>
    SG_NODISCARD static NovaGloveSensorData Parse(const std::string& rawData, const SGCore::Nova::NovaGloveInfo& gloveInfo);
...
public:
    ...
    SG_NODISCARD float GetSensorValue(int32_t finger, NovaGloveSensorData::ESensorLocation location) const;
